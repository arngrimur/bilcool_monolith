...
module "frontend" {
  ...
  bookings_function_url_domain       = module.bookings_http.function_url_domain
  authentication_function_url_domain = module.authentication_http.function_url_domain
  event_ledger_function_url_domain   = module.event_ledger_http.function_url_domain
